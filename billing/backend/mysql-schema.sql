...
INSERT IGNORE INTO permissions (permission_key, label, module) VALUES
  ('can_view_dashboard', 'View dashboard', 'dashboard'),
  ('can_manage_products', 'Manage products', 'products'),
  ('can_manage_inventory', 'Manage inventory', 'inventory'),
  ('can_manage_customers', 'Manage customers', 'customers'),
  ('can_manage_vendors', 'Manage vendors', 'vendors'),
  ('can_manage_invoices', 'Manage invoices', 'invoices'),
  ('can_manage_bills', 'Manage bills', 'bills'),
  ('can_view_reports', 'View reports', 'reports'),
  ('can_manage_company', 'Manage company', 'company'),
  ('can_manage_users', 'Manage users', 'users');
